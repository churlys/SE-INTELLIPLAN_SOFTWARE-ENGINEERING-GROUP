...
<body>
  <aside class="sidebar">
    ...
    <nav class="nav">
      <a class="nav-item" href="dashboard.php"><span class="nav-icon"><img src="assets/icon-dashboard.svg" alt="" aria-hidden="true" width="18" height="18"></span><span class="nav-label">Dashboard</span></a>
