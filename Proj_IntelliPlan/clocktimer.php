        ...
        <div class="ct-main">
          <div class="ct-timer">
            <div class="timer-panel" aria-label="Focus timer">
              ...
              <div class="timer-actions" aria-label="Timer controls">
                <a class="circle-btn circle-btn-soft" href="dashboard.php" aria-label="Back to dashboard">↩</a>
          ...
          <div class="ct-settings" id="pomodoroSettings" aria-label="Pomodoro settings">
            ...
            <div class="ct-field ct-field-toggle">
              <div>
                <div class="ct-label">Alert Sound</div>
                <div class="ct-hint">Play a sound when the timer switches</div>
              </div>
            ...
            <div class="ct-actions">
              <button type="button" class="ct-btn" id="btnCancel">Cancel</button>
              <button type="button" class="ct-btn ct-btn-primary" id="btnSave">Save</button>
            </div>
          </div>
        </div>
      </div>
